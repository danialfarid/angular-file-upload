  ...
  grunt.initConfig({
    ...
    concat: {
      all: {
        ...
        files: {
          'dist/ng-file-upload.js': ['src/upload.js', 'src/model.js', 'src/select.js', 'src/data-url.js', 'src/validate.js', 'src/resize.js', 'src/drop.js', 'src/ngFileUploadApeConfig.js'],
