...
var patchXHR = function(fnName, newFnFn) {
	window.XMLHttpRequest.prototype[fnName] = newFnFn(window.XMLHttpRequest.prototype[fnName]);
};
...
if (window.XMLHttpRequest) {
	if (window.FormData) {
		...
		if (!xhrp.upload) xhrp.upload = {};
		xhrp.__listeners = [];
		xhrp.upload.addEventListener = function(t, fn, b) {
			xhrp.__listeners[t] = fn;
		};
		xhrp.__requestHeaders = [];
